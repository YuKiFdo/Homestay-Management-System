                    ...
                    <div class="breadcrumb-main add-contact justify-content-sm-between ">
                        <div class=" d-flex flex-wrap justify-content-center breadcrumb-main__wrapper">
                            <div class="d-flex align-items-center add-contact__title justify-content-center me-sm-25">
                                <h4 class="text-capitalize fw-500 breadcrumb-title">{{ trans('menu.food-list') }}
                                </h4>
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ trans('menu.food-list') }}
                            </li>
                        </ol>
                    </div>
                </div>
                                            ...
                                            <th>
                                                <div class="d-flex align-items-center">
                                                    <div class="custom-checkbox  check-all">
                                                        ...
                                                        <label for="check-45">
                                                            <span class="checkbox-text userDatatable-title">Item Code</span>
                                                        </label>
                                                    </div>
                                                </div>
                                            </th>
                                            <th>
                                                <span class="userDatatable-title">Food Name</span>
                                            </th>
                                            <th>
                                                ...
                                                <tr>
                                                                ...
                                                                <div class="checkbox-group-wrapper">
                                                                    <div class="checkbox-group d-flex">
                                                                        <div
                                                                            ...
                                                                            <input class="checkbox" type="checkbox" id="check-{{ $food->id }}">
                                                    ...
                                                    <td>
                                                        <ul class="orderDatatable_actions mb-0 d-flex flex-wrap">
                                                            <li>
                                                                <a href="{{ route('foods.edit', [app()->getLocale(), $food->id]) }}"
                                                                    class="edit">
                                                            ...
                                                            <li>
                                                                <a
                                                                    ...
                                                                    onclick="
                                                                        ...
                                                                        if ( confirm('Are you sure you want to delete ?') ) {
                                                                            document.getElementById( 'delete-{{ $food->id }}' ).submit();
                                                                        }
                                                                    "
                                                                >
                                                                ...
                                                                <form style="display:none;" id="delete-{{ $food->id }}"
                                                                    action="{{ route('foods.delete', [app()->getLocale(), $food->id]) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('post')
                                                                </form>
                                ...
                                <li class="dm-pagination__item">
                                    <div class="paging-option">
                                        <select name="page-number" class="page-selection" onchange="updatePagination( event )">
                                            <option value="20" {{ 20 == $foods->perPage() ? 'selected' : '' }}>20/page</option>
                                            <option value="40" {{ 40 == $foods->perPage() ? 'selected' : '' }}>40/page</option>
                                            <option value="60" {{ 60 == $foods->perPage() ? 'selected' : '' }}>60/page</option>
                                        </select>
