            ...
            <div class="col-lg-12">
                <div class="card card-Vertical card-default card-md mb-4">
                    ...
                    <div class="card-body py-md-30">
                        <form action="{{ route('foods.store', app()->getLocale()) }}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-25">
                                    ...
                                    <div class="with-icon">
                                        ...
                                        <input type="text" class="form-control ih-medium ip-light radius-xs b-light" name="price" id="InputEmailIcon" placeholder="">
                                    </div>
                                </div>
