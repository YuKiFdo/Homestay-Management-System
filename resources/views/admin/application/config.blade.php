        ...
        <div class="col-lg-12">
            <div class="card card-Vertical card-default card-md mb-4">
                ...
                <div class="card-body py-md-30">
                    <form method="POST" action="{{ route('application.update', app()->getLocale()) }}" enctype="multipart/form-data" class="row">
                        @csrf
                        <div class="row">
                            <div class="col-md-6 mb-25">
                                <label for="application_name">Application Name</label>
                                <input id="application_name" type="text" class="form-control ih-medium ip-gray radius-xs b-light px-15 @error('application_name') is-invalid @enderror" name="application_name" value="{{ old('application_name') ?? config('application.name') }}" required>
                                ...
                                <div class="dm-tag-wrap">
                                    <div class="dm-upload">
                                        <div class="dm-upload__button">
                                            ...
                                            <input type="file" name="application_logo" class="upload-one @error('application_logo') is-invalid @enderror" id="upload-1">
                                        </div>
